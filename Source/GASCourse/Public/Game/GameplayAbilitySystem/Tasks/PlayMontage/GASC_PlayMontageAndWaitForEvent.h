...
#include "GASC_PlayMontageAndWaitForEvent.generated.h"
 ...
 */
UCLASS()
class GASCOURSE_API UGASC_PlayMontageAndWaitForEvent : public UAbilityTask
{
	GENERATED_BODY()
...
public:
	...
	UGASC_PlayMontageAndWaitForEvent(const FObjectInitializer& ObjectInitializer);
	...
	*/
	...
	static UGASC_PlayMontageAndWaitForEvent* PlayMontageAndWaitForEvent(
